...
runningProductForMultiplicationLoop = 1            # Starts at 1 because multiplying by 1 changes nothing
...
while runningProductForMultiplicationLoop <= thresholdValue:
    currentMultiplier += 1            # Move to the next integer (2, 3, 4, ...)
    runningProductForMultiplicationLoop *= currentMultiplier

# Output the results
print("Final product:", runningProductForMultiplicationLoop)
